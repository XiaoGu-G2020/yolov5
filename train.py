...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default="yolov5m_mys.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default="mys.yaml" / "data/coco128.yaml", help="dataset.yaml path")
